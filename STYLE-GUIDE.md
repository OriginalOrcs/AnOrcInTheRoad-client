...
* When multiple words are needed, always use camelCase.
...
* When naming a class use a capital letter.
...
* Always put spaces after if, for, when, else, and function().
...
* Don't use function statements. They introduce a slew of subtle new rules to how the language behaves, and without a clear benefit it is unecessary.
